...
public class CustomerPage extends BasePage {
    ...
    public void verifyAddNewCustomerSuccess(int row) {
        ...
        WebUI.assertEquals(DriverManager.getDriver().findElement(inputPhoneNumber).getAttribute("value"), excelHelper.getCellData("Phone", row), "The Phone number value not match.");
        WebUI.assertEquals(DriverManager.getDriver().findElement(inputWebsite).getAttribute("value"), excelHelper.getCellData("Website", row), "The Website value not match.");
